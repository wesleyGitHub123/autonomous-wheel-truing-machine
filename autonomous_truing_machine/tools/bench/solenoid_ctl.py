...
run, +/- width, s status, ? help). The board's replies print here and are appended to a log file,
together with anything you note, so what you saw and what the board says it did end up
side by side in one timestamped record.
